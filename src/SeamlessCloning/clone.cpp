...
int main( int argc, char** argv )
{
    ...
    Mat src = imread("./src/SeamlessCloning/images/airplane.jpg");
    Mat dst = imread("./src/SeamlessCloning/images/sky.jpg");
    ...
    // Write result
    imwrite("./src/SeamlessCloning/images/opencv-seamless-cloning-example.jpg", output);
