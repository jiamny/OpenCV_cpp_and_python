...
int main(int argc, char** argv) {
    ...
    Mat foreGroundImage = imread("./src/AlphaBlending/foreGroundAssetLarge.png", -1);
    Mat bgra[4];
    ...
    Mat background = imread("./src/AlphaBlending/backGroundLarge.jpg");
    ...
    imshow("alpha blended using multiply and add", outImage/255);
        waitKey(0);
    ...
    imshow("alpha blended using direct Mat access", outImage/255);
    waitKey(0);
