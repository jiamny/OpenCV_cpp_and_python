...
void readImagesAndTimes(vector<Mat> &images, vector<float> &times)
{
  ...
  static const char* filenames[] = {"./src/HDR/images/img_0.033.jpg", "./src/HDR/images/img_0.25.jpg",
		  "./src/HDR/images/img_2.5.jpg", "./src/HDR/images/img_15.jpg"};
...
int main(int, char**argv)
{
  ...
  // Save HDR image.
  imwrite("./src/HDR/hdrDebevec.hdr", hdrDebevec);
  ...
  ldrDrago = 3 * ldrDrago;
  imwrite("./src/HDR/ldr-Drago.jpg", ldrDrago * 255);
  ...
  imwrite("./src/HDR/ldr-Durand.jpg", ldrDurand * 255);
  ...
  imwrite("./src/HDR/ldr-Reinhard.jpg", ldrReinhard * 255);
  ...
  imwrite("./src/HDR/ldr-Mantiuk.jpg", ldrMantiuk * 255);
