...
int main()
{
  ...
  std::string CamL_id{"./models/stereoL.mp4"}, CamR_id{"./models/stereoR.mp4"}; // These values can change depending on the system
  ...
  cv::FileStorage cv_file = cv::FileStorage("./models/params_cpp.xml", cv::FileStorage::READ);
