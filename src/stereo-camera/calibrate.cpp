...
int main() {
  ...
  std::string pathL = "./models/stereo-camera/stereoL/*.png";
  std::string pathR = "./models/stereo-camera/stereoR/*.png";
  ...
  */
  ...
  cv::FileStorage cv_file = cv::FileStorage("./src/stereo-camera/data/params_cpp.xml", cv::FileStorage::WRITE);
  cv_file.write("./src/stereo-camera/Left_Stereo_Map_x",Left_Stereo_Map1);
  cv_file.write("./src/stereo-camera/Left_Stereo_Map_y",Left_Stereo_Map2);
  cv_file.write("./src/stereo-camera/Right_Stereo_Map_x",Right_Stereo_Map1);
  cv_file.write("./src/stereo-camera/Right_Stereo_Map_y",Right_Stereo_Map2);
  cv_file.release();
  return 0;
}
