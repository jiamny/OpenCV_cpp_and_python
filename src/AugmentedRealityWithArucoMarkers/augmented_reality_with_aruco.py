...
# parser.add_argument('--image', default="test_.jpg", help='Path to image file.')
parser.add_argument('--video', default="video/test.mp4", help='Path to video file.')
