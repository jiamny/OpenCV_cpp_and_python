...
{
  Mat im1 = imread("./src/HuMoments/images/S0.png",IMREAD_GRAYSCALE);
  Mat im2 = imread("./src/HuMoments/images/K0.png",IMREAD_GRAYSCALE);
  Mat im3 = imread("./src/HuMoments/images/S4.png",IMREAD_GRAYSCALE);
