...
string protoFile = "./models/HandPose/pose_deploy.prototxt";
string weightsFile = "./models/HandPose/pose_iter_102000.caffemodel";
...
int main(int argc, char **argv) {
    ...
    string imageFile = "./src/HandPose/right-frontal.jpg";
