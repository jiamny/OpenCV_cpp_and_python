...
int main(int argc, char **argv)
{
  ...
  string dirName = "./src/EigenFace/images/";
...
//    createTrackbar( "Weight" + to_string(i), "Trackbars", &sliderValues[i], MAX_SLIDER_VALUE, createNewFace);
    createTrackbar( "Weight" + to_string(i), "Trackbars", nullptr, MAX_SLIDER_VALUE, createNewFace);
    cv::setTrackbarPos("Weight" + to_string(i), "Trackbars", sliderValues[i]);
  }
