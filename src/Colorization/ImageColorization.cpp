...
int main() {
	...
	string imageFileName = "./src/Colorization/image/greyscaleImage.png";
	...
	string protoFile = "./models/Colorization/colorization_deploy_v2.prototxt";
	string weightsFile = "./models/Colorization/colorization_release_v2.caffemodel";
