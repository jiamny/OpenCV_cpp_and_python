...
int main(int, char**) {
    ...
    ifstream ifs(string("./models/Deep-Learning-with-DNN-Module/object_detection_classes_coco.txt").c_str());
    string line;
    ...
    auto model = readNet("./models/Deep-Learning-with-DNN-Module/frozen_inference_graph.pb",
                        "./models/Deep-Learning-with-DNN-Module/ssd_mobilenet_v2_coco_2018_03_29.pbtxt.txt",
                        "TensorFlow");

    // capture the video
    VideoCapture cap("./src/Deep-Learning-with-DNN-Module/input/video_1.mp4");
    // get the video frames' width and height for proper saving of videos
    int frame_width = static_cast<int>(cap.get(3));
    int frame_height = static_cast<int>(cap.get(4));
    // create the `VideoWriter()` object
    VideoWriter out("./src/Deep-Learning-with-DNN-Module/outputs/video_result.avi", VideoWriter::fourcc('M', 'J', 'P', 'G'), 30,
