...
int main(int argc,char** argv) {
	std::string inputFile = "./src/OpenPose-Multi-Person/group.jpg";
	...
	cv::dnn::Net inputNet = cv::dnn::readNetFromCaffe("./models/OpenPose/coco/pose_deploy_linevec.prototxt",
														"./models/OpenPose/coco/pose_iter_440000.caffemodel");
